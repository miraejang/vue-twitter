...
import TwitterRegister from "../pages/register.vue";
import TwitterLogin from "../pages/login.vue";

const routes = [
  { path: '/', component: TwitterHome, title: '홈', icon: 'fas fa-home fa-fw', meta: { isMenu: true, layout: 'DefaultLayout' } },
  { path: '/', component: TwitterHome, title: '탐색하기', icon: 'fas fa-hashtag fa-fw', meta: { isMenu: true, layout: 'DefaultLayout' } },
