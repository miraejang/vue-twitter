      ...
      <div class="flex flex-col" v-if="tweet">
        ...
        <div class="flex justify-around py-2">
          ...
          <button @click="handleRetweet(tweet)">
            <i :class="[tweet.isRetweeted ? 'text-green-400' : '']" class="fas fa-retweet text-gray-400 text-xl hover:bg-green-50 hover:text-green-400 p-2 rounded-full w-10 h-10"></i>
          </button>
          <button @click="handleLikes(tweet)">
            <i :class="[tweet.isLiked ? 'text-red-500' : '']" class="far fa-heart text-gray-400 text-xl hover:bg-red-50 hover:text-red-400 p-2 rounded-full w-10 h-10"></i>
          </button>
        </div>
        <div class="h-px w-full bg-gray-100"></div>
        <!-- comments -->
